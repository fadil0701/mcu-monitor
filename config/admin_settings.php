        ...
        'general' => [
            ...
            'fields' => [
                ...
                'mcu_interval_years' => [
                    ...
                    'default' => (int) env('MCU_INTERVAL_YEARS', 1),
                    'help' => 'Sumber utama pengaturan interval. Acuan tahun kalender (tahun berjalan): misalnya nilai 1 = peserta hanya boleh mengajukan sekali per tahun kalender yang berbeda. Nilai .env MCU_INTERVAL_YEARS hanya dipakai sebagai fallback awal sebelum setting ini disimpan.',
                ],
            ],
        ],
