        ...
        'whatsapp' => [
            ...
            'fields' => [
                ...
                'whatsapp_apico_template_language' => [
                    'label' => 'Bahasa Template WA',
                    'type' => 'text',
                    'group' => 'whatsapp',
                    'storage_type' => 'string',
                    'rules' => 'nullable|string|max:10',
                    'placeholder' => 'id',
                    'help' => 'Kode bahasa template Meta, biasanya id atau en_US.',
                ],
                'whatsapp_apico_invitation_param_keys' => [
                    ...
                    'storage_type' => 'string',
                    'rules' => 'nullable|string|max:500',
                    'placeholder' => 'nama_lengkap,tanggal_pemeriksaan,jam_pemeriksaan,lokasi_pemeriksaan,queue_number',
                    'help' => 'Urutan variabel body template {{1}}, {{2}}, ... dipisah koma. Harus sama dengan template di Meta.',
                ],
