...
@section('pageTitle', 'Tambah PDF Template')

@section('content')

<x-common.component-card title="Form PDF Template">
    <form method="POST" action="{{ route('admin.pdf-templates.store') }}">
        @csrf
        <div class="row g-3">
            <div class="col-md-6">
            ...
            <div class="col-12">
                ...
                <textarea name="combined_html" id="combined_html" rows="16" class="form-control @error('combined_html') is-invalid @enderror">{{ old('combined_html') }}</textarea>
        ...
        <x-admin.form-actions :cancelUrl="route('admin.pdf-templates.index')" />
    </form>
