...
@section('pageTitle', 'Tambah Peserta')
    ...
    <form method="POST" action="{{ route('admin.participants.store') }}">
        ...
        <div class="row g-3">
            <div class="col-md-6">
                ...
                <input type="text" id="nik_ktp" name="nik_ktp" value="{{ old('nik_ktp') }}" maxlength="16" required class="form-control @error('nik_ktp') is-invalid @enderror">
                @error('nik_ktp')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
            <div class="col-md-6">
                <label for="nrk_pegawai" class="form-label">NRK Pegawai *</label>
                <input type="text" id="nrk_pegawai" name="nrk_pegawai" value="{{ old('nrk_pegawai') }}" required class="form-control @error('nrk_pegawai') is-invalid @enderror">
                @error('nrk_pegawai')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
            <div class="col-12">
                <label for="nama_lengkap" class="form-label">Nama Lengkap *</label>
                <input type="text" id="nama_lengkap" name="nama_lengkap" value="{{ old('nama_lengkap') }}" required class="form-control @error('nama_lengkap') is-invalid @enderror">
                @error('nama_lengkap')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
            <div class="col-md-6">
                <label for="tempat_lahir" class="form-label">Tempat Lahir *</label>
                <input type="text" id="tempat_lahir" name="tempat_lahir" value="{{ old('tempat_lahir') }}" required class="form-control @error('tempat_lahir') is-invalid @enderror">
                @error('tempat_lahir')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
            <div class="col-md-6">
                <label for="tanggal_lahir" class="form-label">Tanggal Lahir *</label>
                <input type="date" id="tanggal_lahir" name="tanggal_lahir" value="{{ old('tanggal_lahir') }}" required class="form-control @error('tanggal_lahir') is-invalid @enderror">
            ...
            <div class="col-md-6">
                ...
                <input type="text" id="skpd" name="skpd" value="{{ old('skpd') }}" required class="form-control @error('skpd') is-invalid @enderror">
                @error('skpd')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
            <div class="col-md-6">
                <label for="ukpd" class="form-label">UKPD *</label>
                <input type="text" id="ukpd" name="ukpd" value="{{ old('ukpd') }}" required class="form-control @error('ukpd') is-invalid @enderror">
            ...
            <div class="col-md-6">
                ...
                <input type="date" id="tanggal_mcu_terakhir" name="tanggal_mcu_terakhir" value="{{ old('tanggal_mcu_terakhir') }}" class="form-control @error('tanggal_mcu_terakhir') is-invalid @enderror">
